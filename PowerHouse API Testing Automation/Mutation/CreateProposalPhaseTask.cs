...
namespace PowerHouse_Api
{
    ...
    public class CreateProposalPhaseTask
    {
  ...
  createProposalPhaseTask(data: $data, phase_id: $phaseId) {
    ...
    ",
        ...
        public void VerifyResponse()
        {
            ...
            string description = obj["createProposalPhaseTask"]["description"].ToString();
            string taskTitle = obj["createProposalPhaseTask"]["title"].ToString();
            int hardcost = obj["createProposalPhaseTask"]["hard_cost"].Value<int>();
            int phaseId = obj["createProposalPhaseTask"]["phase_id"].Value<int>();
