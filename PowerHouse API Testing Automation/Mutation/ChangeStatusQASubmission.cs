...
{ 
    ...
    public class ChangeStatusQASubmission
    {
  ...
  changeStatusQASubmission(
    ...
    ",
        ...
        public void VerifyResponse()
        {
            ...
            string returnPr = obj["changeStatusQASubmission"]["pr"].ToString();
            string returnComment = obj["changeStatusQASubmission"]["comments"].ToString();
            int returnTransactionId = obj["changeStatusQASubmission"]["transaction_id"].Value<int>();    
