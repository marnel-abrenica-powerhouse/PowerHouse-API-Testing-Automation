  ...
  getAllProposals(filters: $filters) {
    ...
    ",
        ...
        public void PostTest()
        {
            ...
            int userId = obj["getAllProposals"][0]["client"]["user_id"].Value<int>();
            string clientEmail = obj["getAllProposals"][0]["client_email"].ToString();
            string clientName = obj["getAllProposals"][0]["client_name"].ToString();
            string proposalName = obj["getAllProposals"][0]["name"].ToString();
            string proposalNotes = obj["getAllProposals"][0]["notes"].ToString();
            int orgId = obj["getAllProposals"][0]["organization_id"].Value<int>();
