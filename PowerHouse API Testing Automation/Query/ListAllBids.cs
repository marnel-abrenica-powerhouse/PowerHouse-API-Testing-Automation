...
namespace PowerHouse_Api
{
    ...
    public class ListAllBids
    {
        ...
        public async Task MainTest()
        {
            ...
            {
                Query = @"
query ListAllBids($filters: ListAllBids!) {
  listAllBids(filters: $filters) {
    amount
    created_at
    id
    status
    ...
    ",
        ...
        public void PostTest()
        {
            ...
            int returnTaskId = obj["listAllBids"][0]["task_id"].Value<int>();
            int returnBidId = obj["listAllBids"][0]["id"].Value<int>();
