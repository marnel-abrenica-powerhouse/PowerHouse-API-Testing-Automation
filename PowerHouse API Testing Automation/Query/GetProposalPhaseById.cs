...
namespace PowerHouse_Api
{
    ...
    public class GetProposalPhaseById
    {
        ...
        public async Task MainTest()
        {
            ...
            {
                Query = @"
query GetProposalPhaseById($getProposalPhaseByIdId: Float!) {
  getProposalPhaseById(id: $getProposalPhaseByIdId) {
    amount_paid
    created_at
    duration_span
    duration_type
    ...
    ",
                Variables = new
                {
                    getProposalPhaseByIdId = PhaseId
        ...
        public void PostTest()
        {
            ...
            string phaseTitle = obj["getProposalPhaseById"]["title"].ToString();
            int proposalId = obj["getProposalPhaseById"]["proposal_id"].Value<int>();
            int phaseId = obj["getProposalPhaseById"]["id"].Value<int>();
