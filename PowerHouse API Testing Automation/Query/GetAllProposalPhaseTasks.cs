...
namespace PowerHouse_Api
{
    ...
    public class GetAllProposalPhaseTasks
    {
        ...
        public void Precondition()
        {
            ...
            string returnTaskId = new CreateProposalPhaseTask_Reusable().Invoke(Task2Title, Task2HardCost, Task2Description, PhaseId);
            JObject objTaskId = JObject.Parse(returnTaskId);
            TaskId = objTaskId["createProposalPhaseTask"]["id"].Value<int>();
        }
        ...
        public async Task MainTest()
        {
            ...
            {
                Query = @"
query GetAllProposalPhaseTasks($filters: GetAllProposalPhasesTasksFiltersDTO) {
  getAllProposalPhaseTasks(filters: $filters) {
    created_at
    description
    hard_cost
    id
    ...
    ",
        ...
        public void VerifyResponse()
        {
            ...
            string description = obj["getAllProposalPhaseTasks"][0]["description"].ToString();
            string taskTitle = obj["getAllProposalPhaseTasks"][0]["title"].ToString();
            int hardcost = obj["getAllProposalPhaseTasks"][0]["hard_cost"].Value<int>();
            int phaseId = obj["getAllProposalPhaseTasks"][0]["phase_id"].Value<int>();


            if (
                   description != Task2Description
                || taskTitle!= Task2Title
                || hardcost != Task2HardCost
                || phaseId != PhaseId
